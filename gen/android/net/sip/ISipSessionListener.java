 ...
 * Original file: /home/hceylan/Projects/android/workspace/VoipBackport/src/android/net/sip/ISipSessionListener.aidl
 */
...
static final int TRANSACTION_onCallChangeFailed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_onRegistering = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_onRegistrationDone = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_onRegistrationFailed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_onRegistrationTimeout = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
}
/**
     * Called when an INVITE request is sent to initiate a new call.
     *
